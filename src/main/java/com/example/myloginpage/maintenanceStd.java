...
public class maintenanceStd extends Fragment implements Toolbar.OnMenuItemClickListener {
...
Button button,btn,back;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_maintenance_std, container, false);
        ...
        String url = "https://assettrack.cx/android_api/maintanencestd.php";
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        String maintain = jsonObject.optString("stdDesc");
