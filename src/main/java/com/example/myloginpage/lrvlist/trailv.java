...
public class trailv extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view= inflater.inflate(R.layout.fragment_trailv, container, false);
        ...
        String lrvid = user1.get(sharedPrefrencesHelper.LRVNOT);
        HashMap<String, String> user2 = sharedPrefrencesHelper.lrvdetails1();
        String congf1 = user2.get(sharedPrefrencesHelper.CONGF);
        String lrvid1 = user2.get(sharedPrefrencesHelper.LRVNOT);

        if(congf.equals("2")) {

            requestQueue = Volley.newRequestQueue(getActivity());
            String url = "https://assettrack.cx/android_api/lrvchklistt.php?chklistID=" + chkid + "&lrvno=" + lrvid;
                ...
                public void onResponse(JSONObject response) {
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            String lv = jsonObject.optString("trailv");
                            textView.setText("Trail Vehicle:  " + lv);
            ...
            requestQueue = Volley.newRequestQueue(getActivity());
            String url = "https://assettrack.cx/android_api/lrvchklistt.php?chklistID=" + chkid + "&lrvno=" + lrvid1;
