...
public class midv extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_midv, container, false);
        ...
        String lrvid = user2.get(sharedPrefrencesHelper.LRVNOM);
        String url ="https://assettrack.cx/android_api/lrvchklistm.php?chklistID=" +chkid+ "&lrvno=" + lrvid;
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        String lv = jsonObject.optString("midv");
                        textView.setText("Mid Vehicle:  " + lv);
